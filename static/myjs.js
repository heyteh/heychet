                                              ...
                                              <div class="media-content">
                                                  ...
                                                  <nav class="level is-mobile">
                                                      <div class="level-left">
                                                          <a
                                                           class="level-item is-sparta" aria-label="heart" onclick="toggle_like('${post["_id"]}', 'heart')">                                                                                     
                                                              ...
                                                              <i class="fa ${class_heart}"aria-hidden="true"></i>
                                                               ...
                                                               <a
                                                               class="level-item is-sparta" aria-label="star" onclick="toggle_like('${post["_id"]}', 'star')">                                                                                     
                                                                  <span class="icon is-small">
                                                                  <i class="fa ${class_star}"aria-hidden="true"></i>
                                                                   ...
                                                                   <a
                                                                   class="level-item is-sparta" aria-label="thumbsup" onclick="toggle_like('${post["_id"]}', 'thumbsup')">                                                                                     
                                                                      <span class="icon is-small">
